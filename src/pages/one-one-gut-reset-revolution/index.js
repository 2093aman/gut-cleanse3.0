            ...
            <div className="col-xl-6 col-lg-6 pb-10">
              <div className="mb-30  " data-aos="fade-right">
                <div className="section-title-2">
                  <h2> Your Relationship with Health through the 1:1 Gut Reset Revolution
                  </h2>
                </div>
                <div className="about-text  ">
                  <p className="mb-5">
                    Unlock lasting vitality by harmonizing your gut health, hormone balance, and mindful eating practices through this signature wellness program, crafted from over a decade of clinical success stories.
                  ...
                  <ul className="list-item">
                    <li>
                      <h4>
                        ...
                        Personalized 3-6 Month Journey with a dedicated nutrition expert guiding your transformation
                    ...
                    <li>
                      <h4>
                        ...
                        Custom Supplement Protocols tailored to your body’s needs for optimal health
                    ...
                    <li>
                      <h4>
                        ...
                        Flexible Meal Planning designed to fit your lifestyle and ensure long-term sustainability
                    ...
                    <li>
                      <h4>
                        ...
                        Mindful Eating Guidance to shift eating from stress to a source of joy
                      </h4>
                    </li>
                    <li>
                      <h4>
                        ...
                        Holistic Approach addressing gut health, hormone balance, and behavioral psychology
                    ...
                    <li>
                      <h4>
                        ...
                        Continuous WhatsApp Support for ongoing accountability and expert guidance
                      </h4>
                    </li>
                    <li>
                      <h4>
                        ...
                        Pregnancy/Postpartum Support for expert nutrition and wellness advice during your pregnancy journey or recovery
                    ...
                    <li>
                      <h4>
                        ...
                        Behavioral Psychology Insights to tackle stress and foster a positive relationship with food
              ...
              <div className="fancybox-item" data-aos="fade-up">
                <div className="fancybox-body  d-flex">
                  ...
                  <div className="weeklist">
                    ...
                    <p>
                      Transform your health journey with expert guidance and practical solutions for just ₹45000. True health transformation begins with gut healing. Join the 1:1 Gut Reset Revolution and start optimizing your gut health, hormone balance, and overall wellness with personalized support.
